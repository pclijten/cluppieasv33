...
import { db, doc, updateDoc } from './firebase.js?v=20260922b';
import { S, esc, meld, datumNL, modAan } from './state.js?v=20260922b';
import { AFWEZIG_REDENEN, afwezigRedenInfo } from './config.js?v=20260922b';
...
import { ongelezenBerichten } from './berichten.js?v=20260922b';
