...
import { startTeams, openTeam, renderTeam, verlaatTeamView } from './teams.js?v=20260811a';
...
const openClubLazy = id => import('./club.js?v=20260811a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260811a').then(m => m.verlaatClubView());
