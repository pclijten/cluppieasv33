...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260828d';
import { sluitWedstrijd } from './wedstrijd.js?v=20260828d';
import { initChatbot } from './chatbot.js?v=20260828d';
...
const openClubLazy = id => import('./club.js?v=20260828d').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260828d').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260828d').then(m => m.clubTerugEen());
