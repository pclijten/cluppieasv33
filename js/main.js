...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260817d';
import { sluitWedstrijd } from './wedstrijd.js?v=20260817d';
...
const openClubLazy = id => import('./club.js?v=20260817d').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260817d').then(m => m.verlaatClubView());
