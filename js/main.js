...
import { startTeams, openTeam, renderTeam, verlaatTeamView } from './teams.js?v=20260814b';
import { sluitWedstrijd } from './wedstrijd.js?v=20260814b';
import { initChatbot } from './chatbot.js?v=20260814b';
...
const openClubLazy = id => import('./club.js?v=20260814b').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260814b').then(m => m.verlaatClubView());
