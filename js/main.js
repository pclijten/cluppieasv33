...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260826c';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260826c';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260826c';
import { sluitWedstrijd } from './wedstrijd.js?v=20260826c';
...
const openClubLazy = id => import('./club.js?v=20260826c').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260826c').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260826c').then(m => m.clubTerugEen());
