...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260816a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260816a';
import { initChatbot } from './chatbot.js?v=20260816a';
...
const openClubLazy = id => import('./club.js?v=20260816a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260816a').then(m => m.verlaatClubView());
