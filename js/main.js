...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260828d';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260828d';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260829c';
import { sluitWedstrijd } from './wedstrijd.js?v=20260829c';
import { initChatbot } from './chatbot.js?v=20260829c';
...
const openClubLazy = id => import('./club.js?v=20260829c').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260829c').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260829c').then(m => m.clubTerugEen());
