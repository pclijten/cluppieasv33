...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260905b';
import { sluitWedstrijd } from './wedstrijd.js?v=20260905b';
import { initChatbot } from './chatbot.js?v=20260905b';
...
const openClubLazy = id => import('./club.js?v=20260905b').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260905b').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260905b').then(m => m.clubTerugEen());
