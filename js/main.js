...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260811a';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260814a';
import { startTeams, openTeam, renderTeam, verlaatTeamView } from './teams.js?v=20260814a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260814a';
import { initChatbot } from './chatbot.js?v=20260814a';
...
const openClubLazy = id => import('./club.js?v=20260814a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260814a').then(m => m.verlaatClubView());
