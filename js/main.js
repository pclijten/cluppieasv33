...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260918a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260918a';
...
const openClubLazy = id => import('./club.js?v=20260918a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260918a').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260918a').then(m => m.clubTerugEen());
