...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260814e';
import { sluitWedstrijd } from './wedstrijd.js?v=20260814e';
import { initChatbot } from './chatbot.js?v=20260814e';
...
const openClubLazy = id => import('./club.js?v=20260814e').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260814e').then(m => m.verlaatClubView());
