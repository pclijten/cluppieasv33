...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260818c';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260818c';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260818c';
import { sluitWedstrijd } from './wedstrijd.js?v=20260818c';
import { initChatbot } from './chatbot.js?v=20260818c';
...
const openClubLazy = id => import('./club.js?v=20260818c').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260818c').then(m => m.verlaatClubView());
