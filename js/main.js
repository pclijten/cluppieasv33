...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260819d';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260819d';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260819m';
import { sluitWedstrijd } from './wedstrijd.js?v=20260819m';
import { initChatbot } from './chatbot.js?v=20260819m';
...
const openClubLazy = id => import('./club.js?v=20260819m').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260819m').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260819m').then(m => m.clubTerugEen());
