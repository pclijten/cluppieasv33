...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260815b';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260815b';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260815b';
import { sluitWedstrijd } from './wedstrijd.js?v=20260815b';
...
const openClubLazy = id => import('./club.js?v=20260815b').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260815b').then(m => m.verlaatClubView());
