...
const openClubLazy = id => import('./club.js?v=20260822b').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260822b').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260822b').then(m => m.clubTerugEen());
