...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260825d';
import { sluitWedstrijd } from './wedstrijd.js?v=20260825d';
import { initChatbot } from './chatbot.js?v=20260825d';
...
const openClubLazy = id => import('./club.js?v=20260825d').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260825d').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260825d').then(m => m.clubTerugEen());
