...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260815c';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260815c';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260815c';
import { sluitWedstrijd } from './wedstrijd.js?v=20260815c';
import { initChatbot } from './chatbot.js?v=20260815c';
...
const openClubLazy = id => import('./club.js?v=20260815c').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260815c').then(m => m.verlaatClubView());
