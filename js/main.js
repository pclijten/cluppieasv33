...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260923f';
import { sluitWedstrijd } from './wedstrijd.js?v=20260923f';
import { initChatbot } from './chatbot.js?v=20260923f';
...
const openClubLazy = id => import('./club.js?v=20260923f').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260923f').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260923f').then(m => m.clubTerugEen());
