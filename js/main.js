...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260819j';
import { sluitWedstrijd } from './wedstrijd.js?v=20260819j';
import { initChatbot } from './chatbot.js?v=20260819j';
...
const openClubLazy = id => import('./club.js?v=20260819j').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260819j').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260819j').then(m => m.clubTerugEen());
