...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260907a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260907a';
import { initChatbot } from './chatbot.js?v=20260907a';
...
const openClubLazy = id => import('./club.js?v=20260907a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260907a').then(m => m.verlaatClubView());
S._navClubTerug      = () => import('./club.js?v=20260907a').then(m => m.clubTerugEen());
