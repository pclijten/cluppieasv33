...
import { S, $, initModalSluiten, meld, initTerugknop, initGlobaleFoutafhandeling } from './state.js?v=20260815a';
import {
  initAuthUI, checkUitnodiging, handelPendingJoin, verwerkDeeplink, registreerLogin
} from './auth.js?v=20260815a';
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260815a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260815a';
import { initChatbot } from './chatbot.js?v=20260815a';
...
const openClubLazy = id => import('./club.js?v=20260815a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260815a').then(m => m.verlaatClubView());
