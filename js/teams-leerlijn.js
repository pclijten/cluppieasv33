...
import { S, $, esc, openModal, modAan } from './state.js?v=20260902d';
import { skillDomein, leercurveThema, isoWeek, kompasIndexVoorWeek,
         LEERCURVE, leercurveRelevant } from './config.js?v=20260902d';
import { contentVoorThema, kompasTips } from './content.js?v=20260902d';
