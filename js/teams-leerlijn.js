...
import { S, $, esc, openModal, modAan } from './state.js?v=20260815a';
import { skillDomein, leercurveThema, isoWeek, kompasIndexVoorWeek } from './config.js?v=20260815a';
import { contentVoorThema, kompasTips } from './content.js?v=20260815a';
