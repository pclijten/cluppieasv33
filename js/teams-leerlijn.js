...
import { S, $, esc, openModal, modAan } from './state.js?v=20260922b';
import { skillDomein, leercurveThema, isoWeek, kompasIndexVoorWeek,
         LEERCURVE, leercurveRelevant } from './config.js?v=20260922b';
import { contentVoorThema, kompasTips } from './content.js?v=20260922b';
