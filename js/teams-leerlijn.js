...
import { S, $, esc, openModal, modAan } from './state.js?v=20260828c';
import { skillDomein, leercurveThema, isoWeek, kompasIndexVoorWeek,
         LEERCURVE, leercurveRelevant } from './config.js?v=20260828c';
import { contentVoorThema, kompasTips } from './content.js?v=20260828c';
