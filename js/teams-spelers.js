...
import { analyseWedstrijd, speeltijdReserve, disciplinaireTijd } from './analyse.js?v=20260815c';
import { ico } from './icons.js?v=20260815c';

import { toonThemaInfo } from './teams-leerlijn.js?v=20260815c';
...
async function herrenderTeam(){
  const m = await import('./teams.js?v=20260815c');
  m.renderTeam();
}
