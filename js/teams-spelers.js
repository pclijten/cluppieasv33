...
import { analyseWedstrijd, speeltijdReserve, disciplinaireTijd } from './analyse.js?v=20260818b';
import { ico } from './icons.js?v=20260818b';

import { toonThemaInfo } from './teams-leerlijn.js?v=20260818b';
...
async function herrenderTeam(){
  const m = await import('./teams.js?v=20260818b');
  m.renderTeam();
}
