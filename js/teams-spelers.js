...
import { analyseWedstrijd, speeltijdReserve, disciplinaireTijd } from './analyse.js?v=20260828b';
import { ico } from './icons.js?v=20260825b';

import { toonThemaInfo } from './teams-leerlijn.js?v=20260828b';
...
async function herrenderTeam(){
  const m = await import('./teams.js?v=20260828b');
  m.renderTeam();
}
