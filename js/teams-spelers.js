...
import { analyseWedstrijd, speeltijdReserve, disciplinaireTijd } from './analyse.js?v=20260822a';
import { ico } from './icons.js?v=20260818e';

import { toonThemaInfo } from './teams-leerlijn.js?v=20260822a';
...
async function herrenderTeam(){
  const m = await import('./teams.js?v=20260822c');
  m.renderTeam();
}
