...
import { analyseWedstrijd, speeltijdReserve, disciplinaireTijd } from './analyse.js?v=20260818e';
import { ico } from './icons.js?v=20260818e';

import { toonThemaInfo } from './teams-leerlijn.js?v=20260818e';
...
async function herrenderTeam(){
  const m = await import('./teams.js?v=20260818e');
  m.renderTeam();
}
