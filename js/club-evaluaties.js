...
import { db, collection, getDocs, query, where } from './firebase.js?v=20260727';
import { S, esc, meld, openModal } from './state.js?v=20260727';
import { TEAM_CATEGORIEEN, SKILLS } from './config.js?v=20260727';
