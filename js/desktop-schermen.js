...
import { renderTeam, zetTeamTab, modalTeamEvaluatie, planningItems } from './teams.js?v=20260925c';
import { evaluatieOpen, presWedstrijdKeuzes } from './teams-hub.js?v=20260924b';
import { spelerStats, meestGespeeldePosities } from './teams-spelers.js?v=20260925c';
import { bewaarTeamEvaluatie } from './teams-evaluatie.js?v=20260925c';
...
async function actie(b){
  ...
  if (a === 'openw'){ const m = await import('./wedstrijd.js?v=20260925c'); m.openWedstrijd(id); return; }
  if (a === 'nieuwew'){ const m = await import('./wedstrijd.js?v=20260925c'); m.modalNieuweWedstrijd(); return; }
  ...
  if (a === 'beoordeel'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalVolledigeBeoordeling(S._beoordeelProfiel); return; }
  if (a === 'leerpunt'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalLeerpunt(S._beoordeelProfiel); return; }
  if (a === 'lpthema'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalLeerpunt(id, selThema); return; }
  if (a === 'snelronde'){ const m = await import('./teams-spelers.js?v=20260925c'); m.startSnelRonde(); return; }
  if (a === 'nieuwsp'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalSpeler(null); return; }
  ...
  if (a === 'snel'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalSnelBeoordeling(S._beoordeelProfiel); return; }
  if (a === 'evopen'){ const bo = S.beoordelingen.find(x => x.id === id); if (!bo) return; const m = await import('./teams-spelers.js?v=20260925c');
  ...
  if (a === 'spuitleen'){ const m = await import('./teams-spelers.js?v=20260925c'); m.modalUitlenen(S._beoordeelProfiel); return; }
  if (a === 'spterug'){ const m = await import('./teams-spelers.js?v=20260925c'); await m.trekUitleningIn(id); renderTeam(); return; }
  ...
  if (a === 'plandag'){ const { datum, bron, doc: did } = b.dataset;
    if (bron === 'wedstrijd' && did){ const m = await import('./wedstrijd.js?v=20260925c'); m.openWedstrijd(did); return; }
