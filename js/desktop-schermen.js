...
import { renderTeam, zetTeamTab, modalTeamEvaluatie, planningItems } from './teams.js?v=20260925d';
import { evaluatieOpen, presWedstrijdKeuzes } from './teams-hub.js?v=20260924b';
import { spelerStats, meestGespeeldePosities } from './teams-spelers.js?v=20260925d';
import { bewaarTeamEvaluatie } from './teams-evaluatie.js?v=20260925d';
...
async function actie(b){
  ...
  if (a === 'openw'){ const m = await import('./wedstrijd.js?v=20260925d'); m.openWedstrijd(id); return; }
  if (a === 'nieuwew'){ const m = await import('./wedstrijd.js?v=20260925d'); m.modalNieuweWedstrijd(); return; }
  ...
  if (a === 'beoordeel'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalVolledigeBeoordeling(S._beoordeelProfiel); return; }
  if (a === 'leerpunt'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalLeerpunt(S._beoordeelProfiel); return; }
  if (a === 'lpthema'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalLeerpunt(id, selThema); return; }
  if (a === 'snelronde'){ const m = await import('./teams-spelers.js?v=20260925d'); m.startSnelRonde(); return; }
  if (a === 'nieuwsp'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalSpeler(null); return; }
  ...
  if (a === 'snel'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalSnelBeoordeling(S._beoordeelProfiel); return; }
  if (a === 'evopen'){ const bo = S.beoordelingen.find(x => x.id === id); if (!bo) return; const m = await import('./teams-spelers.js?v=20260925d');
  ...
  if (a === 'spuitleen'){ const m = await import('./teams-spelers.js?v=20260925d'); m.modalUitlenen(S._beoordeelProfiel); return; }
  if (a === 'spterug'){ const m = await import('./teams-spelers.js?v=20260925d'); await m.trekUitleningIn(id); renderTeam(); return; }
  ...
  if (a === 'plandag'){ const { datum, bron, doc: did } = b.dataset;
    if (bron === 'wedstrijd' && did){ const m = await import('./wedstrijd.js?v=20260925d'); m.openWedstrijd(did); return; }
