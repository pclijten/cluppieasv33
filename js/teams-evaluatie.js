...
import { NIVEAUS, niveauKleur, TEAM_CATEGORIEEN, TEAM_TAGS, teamCategorie, SEIZOEN_FALLBACK } from './config.js?v=20260826c';
import { ico } from './icons.js?v=20260825b';

import { htmlStats } from './wedstrijd.js?v=20260826c';
