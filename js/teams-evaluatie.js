...
import { NIVEAUS, niveauKleur, TEAM_CATEGORIEEN, TEAM_TAGS, teamCategorie, SEIZOEN_FALLBACK } from './config.js?v=20260828a';
import { ico } from './icons.js?v=20260825b';

import { htmlStats } from './wedstrijd.js?v=20260828a';
import { telGebruik } from './tracker.js?v=20260828a';
...
export function htmlStatsTab(){
  return htmlSeizoenFilter() + htmlStats() + `
    <button class="knop licht vol" id="statsExcelExport" style="margin-top:14px">
      📊 Exporteer naar Excel</button>`;
}
