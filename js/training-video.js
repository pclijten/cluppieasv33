...
import { db, doc, updateDoc, storage, sRef, uploadBytes, getDownloadURL, deleteObject } from './firebase.js?v=20260922c';
import { S, esc, meld, bewaakTerug, vangnetStilTerugAlsNodig } from './state.js?v=20260922c';
