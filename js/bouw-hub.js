...
import { bouwLeenSnapshot, trekUitleningIn, definitiefOverzetten } from './teams-spelers.js?v=20260925d';
...
export async function openBouwHub(clubId, bouw, isHerbezoek){
  ...
  if (!isHerbezoek && !window.matchMedia('(min-width:1100px) and (min-height:520px)').matches){
    try { const m = await import('./mobiel-bouw.js?v=20260925d'); await m.openMobielBouw(clubId, bouw); return; }
