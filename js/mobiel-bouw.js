...
import { laadBouw, teamRijen, richting } from './desktop-bouw.js?v=20260924a';
import { zetBouwContext, modalNieuweUitleningVanuitBouw } from './bouw-hub.js?v=20260924a';
import { trekUitleningIn } from './teams-spelers.js?v=20260924a';
import { htmlMobielTeam } from './desktop-schermen.js?v=20260924a';
...
async function klik(e){
  ...
  if (a === 'terug'){
    ...
    const m = await import('./teams.js?v=20260924a'); m.renderTeams(); toon('teams'); return;
  }
  ...
  if (a === 'eigen'){ const m = await import('./teams.js?v=20260924a'); m.openTeam(st.teamId, { sel:'spelers', evs:'spelers', evw:'evaluatie', stat:'stats' }[st.pag] || 'hub'); return; }
