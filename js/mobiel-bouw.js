...
import { laadBouw, teamRijen, richting } from './desktop-bouw.js?v=20260925a';
import { zetBouwContext, modalNieuweUitleningVanuitBouw } from './bouw-hub.js?v=20260925a';
import { trekUitleningIn } from './teams-spelers.js?v=20260925a';
import { htmlMobielTeam } from './desktop-schermen.js?v=20260925a';
...
async function klik(e){
  ...
  if (a === 'terug'){
    ...
    const m = await import('./teams.js?v=20260925a'); m.renderTeams(); toon('teams'); return;
  }
  ...
  if (a === 'eigen'){ const m = await import('./teams.js?v=20260925a'); m.openTeam(st.teamId, { sel:'spelers', evs:'spelers', evw:'evaluatie', stat:'stats' }[st.pag] || 'hub'); return; }
