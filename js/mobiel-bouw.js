...
import { laadBouw, teamRijen, richting } from './desktop-bouw.js?v=20260924b';
import { zetBouwContext, modalNieuweUitleningVanuitBouw } from './bouw-hub.js?v=20260924b';
import { trekUitleningIn } from './teams-spelers.js?v=20260924b';
import { htmlMobielTeam } from './desktop-schermen.js?v=20260924b';
...
async function klik(e){
  ...
  if (a === 'terug'){
    ...
    const m = await import('./teams.js?v=20260924b'); m.renderTeams(); toon('teams'); return;
  }
  ...
  if (a === 'eigen'){ const m = await import('./teams.js?v=20260924b'); m.openTeam(st.teamId, { sel:'spelers', evs:'spelers', evw:'evaluatie', stat:'stats' }[st.pag] || 'hub'); return; }
