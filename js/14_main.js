...
import { startTeams, openTeam, renderTeam, verlaatTeamView, teamTabTerug } from './teams.js?v=20260817a';
import { sluitWedstrijd } from './wedstrijd.js?v=20260817a';
import { initChatbot } from './chatbot.js?v=20260817a';
...
const openClubLazy = id => import('./club.js?v=20260817a').then(m => m.openClub(id));
...
S._navVerlaatClub    = () => import('./club.js?v=20260817a').then(m => m.verlaatClubView());
